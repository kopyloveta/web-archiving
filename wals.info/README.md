...
[The WALS](https://wals.info/chapter) – это сайт, созданный лингвистом Юрием Коряковым. Он содержит самую разнообразную информацию о языках мира: карты, реестр языков, сведения о письменностях и фонологии различных языков.

## ArchiveReady

![](/wals.info/ArchiveReady.png)

У [данного сайта](https://archiveready.com/check?url=https%3A%2F%2Fwals.info%2Fchapter) средний рейтинг архивируемости: наиболее низкий показатель у параметра доступности (Accessibility), у остальных параметров показатели также не очень высокие. У сайта отсутствует sitemap, в файле robots.txt есть команды disallow, закрывающие доступ к некоторым областям сайта. Существуют изображения, прикрепленные с других сайтов, есть устаревшие html-теги, а также java-script вставки, также осложняющие полноценную архивацию сайта.
